...
//
//public class RecordingThreadBak {
//    static { System.loadLibrary("snowboy-detect-android"); }
//
//    private static final String TAG = RecordingThreadBak.class.getSimpleName();
//
...
//
//    public RecordingThreadBak(Handler handler, AudioDataReceivedListener listener) {
//        this.handler = handler;
//        this.listener = listener;
//
//        detector.SetSensitivity("0.45");
//        //-detector.SetAudioGain(1);
//        detector.SetAudioGain(2.0f);
//
